...
namespace TrackerUI
{
    public partial class CreateTeamForm : Form
    {
        ...
        private void teamOneScoreLable_Click(object sender, EventArgs e)
        {
        ...
        private void createMemberButton_Click(object sender, EventArgs e)
        {
            if(ValidateForm())
            {
                ...
                MessageBox.Show("Successfully create new member!");
            }
            else
            {
